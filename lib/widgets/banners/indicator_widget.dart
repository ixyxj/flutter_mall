...
class IndicatorWidget extends StatelessWidget {
    ...
    List<Widget> _renderIndicatorTag() {
        ...
        Widget selected = this.indicatorSelected ?? Util.generateIndicatorItem(normal: false);
        Widget normal = this.indicatorNormal ?? Util.generateIndicatorItem(normal: true);
